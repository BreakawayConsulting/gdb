...
bppy_get_commands (PyObject *self, void *closure)
{
  ...
  result = PyUnicode_Decode (cmdstr, strlen (cmdstr), host_charset (), NULL);
  do_cleanups (chain);
  return result;
}
...
bppy_get_type (PyObject *self, void *closure)
{
  ...
  return PyLong_FromLong (self_bp->bp->type);
}
...
bppy_get_number (PyObject *self, void *closure)
{
  ...
  return PyLong_FromLong (self_bp->number);
}
...
bppy_get_thread (PyObject *self, void *closure)
{
  ...
  return PyLong_FromLong (self_bp->bp->thread);
}
...
bppy_get_task (PyObject *self, void *closure)
{
  ...
  return PyLong_FromLong (self_bp->bp->task);
}
...
bppy_get_hit_count (PyObject *self, void *closure)
{
  ...
  return PyLong_FromLong (self_bp->bp->hit_count);
}
...
bppy_get_ignore_count (PyObject *self, void *closure)
{
  ...
  return PyLong_FromLong (self_bp->bp->ignore_count);
}
